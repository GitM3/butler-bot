{
  inputs =
    let
      version = "1.8.2";
system = "x86_64-linux";
devenv_root = "/home/zander/Development/butler-bot/ROS_HUMBLE";
devenv_dotfile = "/home/zander/Development/butler-bot/ROS_HUMBLE/.devenv";
devenv_dotfile_path = ./.devenv;
devenv_tmpdir = "/run/user/1000";
devenv_runtime = "/run/user/1000/devenv-e3b240d";
