{
  inputs =
    let
      version = "1.8.2";
system = "x86_64-linux";
devenv_root = "/home/zander/Development/butler-bot/members/zander/ros_test";
devenv_dotfile = "/home/zander/Development/butler-bot/members/zander/ros_test/.devenv";
devenv_dotfile_path = ./.devenv;
devenv_tmpdir = "/run/user/1000";
devenv_runtime = "/run/user/1000/devenv-2be0138";
