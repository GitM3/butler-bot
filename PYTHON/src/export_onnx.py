...
from rfdetr.detr import (RFDETRBase, RFDETRLarge, RFDETRMedium, RFDETRNano,
                         RFDETRSegPreview, RFDETRSmall)
...
def load_rfdetr_model(cpkt: str):
    try:
        ...
        obj = torch.load(cpkt , weights_only=False,map_location=torch.device('cpu'))
